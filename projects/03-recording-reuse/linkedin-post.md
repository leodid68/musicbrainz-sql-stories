...
`COUNT(DISTINCT release.id)`. For these 3,766 recordings with at least 100
track rows, I also checked that track rows were never fewer than distinct
media, and that distinct media were never fewer than distinct releases.
